...
import React, { useState } from "react";
import { Link } from "react-router-dom";
import styles from "./HeaderTechno.module.scss"; 
import KeyboardArrowUpRoundedIcon from "@mui/icons-material/KeyboardArrowUpRounded"; // Upward arrow
import KeyboardArrowDownRoundedIcon from "@mui/icons-material/KeyboardArrowDownRounded"; // Downward arrow
import cases from '../../../assets/mobile stratagy blue/caseMSBlue.png';
            ...
            {activeDropdown && (
              <ul className={`${styles.dropdown} ${activeDropdown ? styles.show : ''}`}>
                ...
                <li className={styles.listItems}>
                  ...
                  <div>
                    <Link to="/technology/mobile_strategy" className={styles.linkss}>
                      Mobile Strategy
                    </Link>
                    <p className={styles.subhead}>Expertise in Every App: Shaping Exceptional Mobile Experiences with Strategic Innovations.</p>
                  </div>
                </li>

                
                 <li className={styles.listItems}>
                  <img src={devops} className={styles.icon_button} alt="case studies" />
                  <div>
                    <Link to="/technology/frameworks" className={styles.linkss}>
                      Frameworks
                    </Link>
                    <p className={styles.subhead}>Tech-Savvy Frameworks, Tailoring Tech with Simplicity and Precision</p>
                  </div>
                </li>
                </div>
...
<div>
<li className={styles.listItems}>
                  <img src={mobilebi} className={styles.icon_button} alt="solution guides" />
                  <div>
                    <Link to="/technology/mobile_bi" className={styles.linkss}>
                      Mobile BI
                    </Link>
                    <p className={styles.subhead}>Intelligence on the Go: Mobilizing Data with Expert BI Solutions</p>
                  </div>
                </li>
               

                <li className={styles.listItems}>
                  <img src={devops} className={styles.icon_button} alt="solution guides" />
                  <div>
                    <Link to="/technology/devops" className={styles.linkss}>
                     DevOps
                    </Link>
                    <p className={styles.subhead}>Agility, Innovation, Assurance: Your<br/>
                    DevOps Partner in Technological <br/>
                    Excellence</p>
                  </div>
                </li>
                </div>
